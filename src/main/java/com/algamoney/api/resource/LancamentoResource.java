...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> salvar(@Valid @RequestBody Lancamento lancamento, HttpServletResponse response) {
		Lancamento lancamentoSalvo = lancamentoService.salvar(lancamento, response);
		return ResponseEntity.status(HttpStatus.CREATED).body(lancamentoSalvo);
	}
	
	@ExceptionHandler(PessoaInexistenteOuInvativaException.class)
	public ResponseEntity<?> handlePessoaInexistenteOuInvativaException(PessoaInexistenteOuInvativaException ex) {
